...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'yolov5l-seg.pt', help='initial weights path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs_2/train-seg', help='save to project/name')
