...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs_2/train-seg/base/weights/best.pt', help='model path(s)')
    ...
    parser.add_argument('--project', default=ROOT / 'runs_2/val_test', help='save results to project/name')
    parser.add_argument('--name', default='base', help='save to project/name')
